...
const MyProfile = (props) => {
  ...
  const [formErrors, setFormErrors] = useState({
    ...
    password: "",
    confirm_password:
      "Please confirm your current password to make these changes.",
  });
  ...
  const handleChanges = (e) => {
    ...
    if (e.target.name === "hidePassword") {
      ...
      Yup.reach(settingsFormSchema, e.target.name)
        ...
        <FormPage>
          <Form onSubmit={handleSubmit}>
            <InputContainer>
              ...
              <Input type="text" name="first_name" onChange={handleChanges} />
            </InputContainer>
            <br />
            <InputContainer>
              <Label>Last name</Label>
              <Input type="text" name="last_name" onChange={handleChanges} />
            </InputContainer>
            <br />
            <InputContainer>
            ...
            <InputContainer>
              ...
              />
              {update.password && update.password.length < 6 && (
            ...
            <InputContainer>
              ...
              <Input
                ...
                onChange={handleChanges}
              />
              {error && <p className="error">{formErrors.confirm_password}</p>}
            </InputContainer>
          ...
          <DeleteButton onClick={() => handleDeletingStatus()}>
            Delete Account
          </DeleteButton>
        </FormPage>
        {deleting && (
